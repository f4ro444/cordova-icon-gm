...
var getPlatforms = function (projectName) {
    ...
    platforms.push({
        ...
        ionicPath : 'resources/android/icon/',
		isAdded : fs.existsSync('platforms/android'),
        icons : [
            { name : 'drawable/icon.png',         size : 96  ,iname:'drawable-icon.png'},
            { name : 'drawable-hdpi/icon.png',    size : 72  ,iname:'drawable-hdpi-icon.png'},
            { name : 'drawable-ldpi/icon.png',    size : 36  ,iname:'drawable-ldpi-icon.png'},
            { name : 'drawable-mdpi/icon.png',    size : 48  ,iname:'drawable-mdpi-icon.png'},
            { name : 'drawable-xhdpi/icon.png',   size : 96  ,iname:'drawable-xhdpi-icon.png'},
            { name : 'drawable-xxhdpi/icon.png',  size : 144 ,iname:'drawable-xxhdpi-icon.png'},
            { name : 'drawable-xxxhdpi/icon.png', size : 192 ,iname:'drawable-xxxhdpi-icon.png'}
        ]
    });
...
var generateIcon = function (platform, icon) {
    ...
    var file ="";
    if (ionic){
        file = platform.ionicPath + icon.iname;
        //console.log(file);
    }else{
        file = platform.iconsPath + icon.name;
    }
    ...
    gm(settings.ICON_FILE)
      ...
      .write(file, function(err) {
        if (err) {
          ...
          deferred.resolve();
          if (ionic){
            display.success(icon.iname + ' created');
          }else{
